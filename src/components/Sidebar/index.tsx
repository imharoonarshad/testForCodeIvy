  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <h2 className="flex items-center px-3 py-3 font-extrabold text-white">
            Integrate Your Logo 
          </h2>
        </Link>
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <Link
                  href="/"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium dark:text-bodydark1 text-black duration-300 ease-in-out hover:text-white hover:bg-slate-500 dark:hover:bg-meta-4 ${
                    pathname.includes("/") &&
                    "bg-slate-400 dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("leave")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("performance")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("payroll")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("training")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                <Link
                  href="/"
                  className={`group relative mt-8 flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium dark:text-bodydark1 text-black duration-300 ease-in-out hover:text-white hover:bg-slate-500 dark:hover:bg-meta-4 ${
              ...
              <li>
                <div
                  ...
                  className={`group relative flex items-center cursor-pointer gap-2.5 rounded-sm px-4 py-2 font-medium dark:text-bodydark1 text-black duration-300 ease-in-out hover:text-white hover:bg-slate-500 dark:hover:bg-meta-4 ${
